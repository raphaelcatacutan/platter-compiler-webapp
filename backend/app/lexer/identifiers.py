...
class LexerIdentifier(LexerProtocol):
    def s248(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s249()
    ...
    def s250(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s251()
    ...
    def s252(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s253()
    ...
    def s254(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s255()
    ...
    def s256(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s257()
    ...
    def s258(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s259()
    ...
    def s260(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s261()
    ...
    def s262(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s263()
    ...
    def s264(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s265()
    ...
    def s266(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s267()
    ...
    def s268(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s269()
    ...
    def s270(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s271()
    ...
    def s272(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s273()
    ...
    def s274(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s275()
    ...
    def s276(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s277()
    ...
    def s278(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s279()
    ...
    def s280(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s281()
    ...
    def s282(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s283()
    ...
    def s284(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s285()
    ...
    def s286(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s287()
    ...
    def s288(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s289()
    ...
    def s290(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s291()
    ...
    def s292(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s293()
    ...
    def s294(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s295()
    ...
    def s296(self):
        self.advance()
        if self._match_delimiter(self.dlm): return self.s297()
